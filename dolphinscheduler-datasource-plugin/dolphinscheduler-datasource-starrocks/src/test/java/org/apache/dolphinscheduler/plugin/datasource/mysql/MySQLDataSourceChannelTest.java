...
@PrepareForTest({StarrocksDataSourceClient.class, StarrocksDataSourceChannel.class})
public class MySQLDataSourceChannelTest {

    @Test
    public void testCreateDataSourceClient() {
        StarrocksDataSourceChannel sourceChannel = PowerMockito.mock(StarrocksDataSourceChannel.class);
        StarrocksDataSourceClient dataSourceClient = PowerMockito.mock(StarrocksDataSourceClient.class);
