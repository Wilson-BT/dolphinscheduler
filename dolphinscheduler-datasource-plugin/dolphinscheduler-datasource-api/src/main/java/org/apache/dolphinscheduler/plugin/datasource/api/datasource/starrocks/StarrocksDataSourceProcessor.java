...
public class StarrocksDataSourceProcessor extends AbstractDataSourceProcessor {
    ...
    public BaseDataSourceParamDTO createDatasourceParamDTO(String connectionJson) {
        ...
        StarrocksDataSourceParamDTO mysqlDatasourceParamDTO = new StarrocksDataSourceParamDTO();
    ...
    public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO dataSourceParam) {
        StarrocksDataSourceParamDTO mysqlDatasourceParam = (StarrocksDataSourceParamDTO) dataSourceParam;
        ...
        StarrocksConnectionParam satrrocksConnectionParam = new StarrocksConnectionParam();
        satrrocksConnectionParam.setJdbcUrl(jdbcUrl);
        satrrocksConnectionParam.setDatabase(mysqlDatasourceParam.getDatabase());
        satrrocksConnectionParam.setAddress(address);
        satrrocksConnectionParam.setUser(mysqlDatasourceParam.getUserName());
        satrrocksConnectionParam.setPassword(PasswordUtils.encodePassword(mysqlDatasourceParam.getPassword()));
        satrrocksConnectionParam.setDriverClassName(getDatasourceDriver());
        satrrocksConnectionParam.setValidationQuery(getValidationQuery());
        satrrocksConnectionParam.setOther(transformOther(mysqlDatasourceParam.getOther()));
        satrrocksConnectionParam.setProps(mysqlDatasourceParam.getOther());

        return satrrocksConnectionParam;
    }
    ...
    public String getJdbcUrl(ConnectionParam connectionParam) {
        StarrocksConnectionParam satrrocksConnectionParam = (StarrocksConnectionParam) connectionParam;
        String jdbcUrl = satrrocksConnectionParam.getJdbcUrl();
        if (!StringUtils.isEmpty(satrrocksConnectionParam.getOther())) {
            return String.format("%s?%s&%s", jdbcUrl, satrrocksConnectionParam.getOther(), APPEND_PARAMS);
        }
    ...
    public Connection getConnection(ConnectionParam connectionParam) throws ClassNotFoundException, SQLException {
        ...
        String user = satrrocksConnectionParam.getUser();
        ...
        String password = PasswordUtils.decodePassword(satrrocksConnectionParam.getPassword());
