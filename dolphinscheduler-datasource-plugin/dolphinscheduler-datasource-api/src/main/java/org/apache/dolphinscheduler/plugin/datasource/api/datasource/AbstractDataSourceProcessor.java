...
import org.apache.dolphinscheduler.plugin.datasource.api.utils.JdbcUrlSplitUtil;
...
public abstract class AbstractDataSourceProcessor implements DataSourceProcessor {
    ...
    @Override
    public String getHost(ConnectionParam connectionParam) {
        BaseConnectionParam baseConnectionParam = (BaseConnectionParam) connectionParam;
        return JdbcUrlSplitUtil.split(baseConnectionParam.getAddress()).getHost();
    }

    @Override
    public String getDatabase(ConnectionParam connectionParam) {
        BaseConnectionParam baseConnectionParam = (BaseConnectionParam) connectionParam;
        return baseConnectionParam.getDatabase();
    }
}
