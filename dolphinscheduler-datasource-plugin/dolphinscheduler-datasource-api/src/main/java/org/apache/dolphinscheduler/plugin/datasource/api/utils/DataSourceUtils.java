...
public class DataSourceUtils {
    ...
    private static final DataSourceProcessor starrocksProcessor = new StarrocksDataSourceProcessor();
    ...
    public static String getHost(DbType dbType, ConnectionParam connectionParam){
        return getDatasourceProcessor(dbType).getHost(connectionParam);
    }
    ...
    public static String getDatabase(DbType dbType, ConnectionParam dataTargetCfg) {
        return getDatasourceProcessor(dbType).getDatabase(dataTargetCfg);
    }
}
